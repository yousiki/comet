        ...
        let rows: Vec<ActiveChatRow> = {
            ...
            state
                ...
                .map(|(status, chat)| {
                    ...
                    // Organization-shared registries: another member's chat
                    // names its creator — roster name/email when the member
                    // list has loaded, raw user id until then.
